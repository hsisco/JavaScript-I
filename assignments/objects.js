...
{id: 2, email: 'kdiben1@tinypic.com', name: 'Kennan', gender: 'M', speak: () => (`Hello, my name is Kennan!`)},
{id: 3, email: 'kmummery2@wikimedia.org', name: 'Keven', gender: 'M'},
{id: 4, email: 'gmartinson3@illinois.edu', name: 'Gannie', gender: 'M'},
{id: 5, email: 'adaine5@samsung.com', name: 'Antonietta', gender: 'F', multiplyNums: (a, b) => a * b},
]
